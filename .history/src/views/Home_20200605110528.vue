<template>
  <div class="home">
    ...
    <!-- 规则 -->
    <transition name="fade">
      <div class="rule" v-show="isRuleShow"><button class="closeButton" @click="closeModal('rule')"></button></div>
    </transition>
    <!-- 提示次数用完 -->
    <transition name="fade">
      <div class="share" v-show="isShareShow" @click="closeModal('share')"><i class="share-img"></i></div>
    </transition>
  </div>
</template>
