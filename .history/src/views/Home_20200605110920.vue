  ...
  <div class="home">
    ...
    <transition name="fade">
      <div class="rank"
        v-show="isRankShow">
        <ul>
          <li v-for="(item, index) in rankInfo"
            :key="index">
            <dl>
              <dd>{{ item.ranking }}</dd>
        ...
        <button class="closeButton"
          @click="closeModal('rank')"></button>
      </div>
    </transition>
    <!-- 规则 -->
    <transition name="fade">
      <div class="rule"
        v-show="isRuleShow"><button class="closeButton"
          @click="closeModal('rule')"></button></div>
    </transition>
    <!-- 提示次数用完 -->
    <transition name="fade">
      <div class="share"
        v-show="isShareShow"
        @click="closeModal('share')"><i class="share-img"></i></div>
    </transition>
  </div>
</template>
